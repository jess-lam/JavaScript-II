...
//k Combine both the first and last names and populate a new array called `fullNames`. This array will contain just strings.
let fullNames = [];
...
runners.filter((shirt => runnersLargeSizeShirt.push(shirt.shirt_size === "L")));
console.log(runnersLargeSizeShirt);

// ==== Challenge 4: Use .reduce() ====
// The donations need to be tallied up and reported for tax purposes. Add up all the donations and save the total into a ticketPriceTotal variable.
let ticketPriceTotal = 0;
ticketPriceTotal= runners.reduce((currentTotal, item) => {
